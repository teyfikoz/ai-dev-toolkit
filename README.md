...
| # | Category | Repos |
|---|----------|-------|
| 01 | [Claude Code & AI Geliştirici Araçları](categories/01-claude-code-ai-dev-tools.md) | 27 |
...
| 09 | [Self-Hosted & DevOps](categories/09-self-hosted-devops.md) | 7 |
| 10 | [Mobil, Oyun & 3D](categories/10-mobile-game-3d.md) | 10 |
| 11 | [Productivity, SaaS & CMS](categories/11-productivity-saas-cms.md) | 9 |
| 12 | [AI Audio, Vision & Görüntü](categories/12-ai-audio-vision-image.md) | 9 |
| 13 | [Big Tech SDK'ları & API İstemcileri](categories/13-big-tech-sdks-apis.md) | 21 |
...
Detaylı rehberler için [`guides/`](guides/) klasörüne bakın.
...
```
ai-dev-toolkit/
├── README.md           ← bu dosya (navigation index)
├── categories/         ← 12 kategori, her biri ayrı .md
├── guides/             ← kurulum ve kullanım rehberleri
├── agents/             ← (yakında)
├── skills/             ← (yakında)
└── tools/              ← (yakında)
```
