...
|---|------|-------|--------------|--------|
| 1 | **fastlane** | 41,496 | Mobil uygulama build ve store yayınlama otomasyonu | [link](https://github.com/fastlane/fastlane) |
| 2 | **phaser** | 39,603 | 2D oyun geliştirme framework'ü | [link](https://github.com/phaserjs/phaser) |
| 3 | **godot** | 96,000 | 2D ve 3D oyun geliştirme motoru | [link](https://github.com/godotengine/godot) |
| 4 | **RoboMaster-SDK** | 1,800 | DJI drone'u Python ile programlama SDK'sı | [link](https://github.com/dji-sdk/RoboMaster-SDK) |
| 5 | **ShipSwift** | 830 | LLM uretilen uygulamalar icin production-ready SwiftUI bilesenleri | [link](https://github.com/signerlabs/ShipSwift) |
| 6 | **agent-device** | 610 | AI agentlarin gercek mobil ve masaustu uygulamalari otomatiklestirmesi | [link](https://github.com/callstackincubator/agent-device) |
