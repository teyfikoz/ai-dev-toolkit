# Productivity, SaaS & CMS

| # | Repo | Stars | Ne İşe Yarar? | GitHub |
|---|------|-------|--------------|--------|
| 1 | **plane** | 48,929 | Jira'ya açık kaynak alternatif | [link](https://github.com/makeplane/plane) |
| 2 | **memos** | 59,470 | Hafif self-hosted not alma ve ikinci beyin uygulaması | [link](https://github.com/usememos/memos) |
| 3 | **payload** | 42,298 | Next.js ile açık kaynak CMS ve admin paneli | [link](https://github.com/payloadcms/payload) |
| 4 | **twenty** | 45,662 | Açık kaynak CRM | [link](https://github.com/twentyhq/twenty) |
| 5 | **quill** | 47,099 | Uygulamaya zengin metin editörü ekleme | [link](https://github.com/slab/quill) |
| 6 | **slidev** | 46,328 | Markdown ile geliştirici dostu sunumlar | [link](https://github.com/slidevjs/slidev) |
| 7 | **chatwoot** | 29,114 | Açık kaynak canlı destek platformu | [link](https://github.com/chatwoot/chatwoot) |
| 8 | **postiz-app** | 30,214 | Sosyal medya içerik planlama aracı | [link](https://github.com/gitroomhq/postiz-app) |
| 9 | **cal.com** | 35,000 | Acik kaynak Calendly; self-hosted meeting scheduler. Calendly Pro: $20/ay -> cal.com: $0 | [link](https://github.com/calcom/cal.com) |
| 10 | **ai-job-search** | 400 | Is arama otomasyonu: is ilani tarama, CV tailoring ve otomatik basvuru. LLM ile CV uyarlama, cover letter uretimi, ATS optimizasyonu. GlobalKariyerim referans | [link](https://github.com/MadsLorentzen/ai-job-search) |
